...
const InviteCard: FC = () => {
  ...
  const invite = validateId === 100 ? {locationId: 2, userList: []} : inviteList[validateId];
  ...
  return(
    <>
      ...
      {validateId === 100 &&
        <div className='info'>
          Для получения более подробной информации о людях в плане рассадки необходимо нажать на любого из них
        </div>
      }
